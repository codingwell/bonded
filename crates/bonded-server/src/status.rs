use crate::frame_forwarder::UdpFlowSnapshot;
use crate::frame_forwarder::UdpSessionTracker;
...
pub async fn run_status_server(
    ...
    loop {
        ...
        let page = render_status_page(&sessions, &udp_tracker.snapshot());
        let response = format!(
...
fn render_status_page(sessions: &SessionRegistry, udp_flows: &[UdpFlowSnapshot]) -> String {
